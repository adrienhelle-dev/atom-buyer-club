...
const STEP_DETAILS = {
  fr: [
    ...
    ["Offre rédigée en votre nom", "Négociation prix & conditions suspensives"],
    ["Notaire partenaire dédié Atom", "Devis artisans verrouillés avant signature", "Délai légal de rétractation : 10 jours (nom propre)"],
    ["Plans 2D + projections 3D incluses", "Sélection mobilier & matériaux premium", "Allers-retours architecte jusqu'à validation"],
    ["Financement coordonné avec la banque", "Signature notariale, remise des clés"],
    ["Chantier piloté par Atom, 0% de marge", "AMO dédiée avec reporting régulier", "Durée moyenne : 8 à 12 semaines"],
    ["Photos & visite virtuelle professionnelles", "Loyer garanti si Atom prend le bien à bail — 1 an renouvelable"],
  ],
  en: [
    ...
    ["Offer written in your name", "Price & suspensive condition negotiation"],
    ["Dedicated Atom partner notary", "Contractor quotes locked before signing", "Legal withdrawal period: 10 days (personal purchase)"],
    ["2D plans + 3D renderings included", "Premium furniture & material selection", "Back-and-forth with architect until approved"],
    ["Financing coordinated with the bank", "Notarial signing, key handover"],
    ["Site managed by Atom, 0% margin", "Dedicated project manager, regular reporting", "Average duration: 8–12 weeks"],
    ["Professional photos & virtual tour", "Rent guaranteed if Atom takes the property on a 1-year renewable lease"],
  ],
};
