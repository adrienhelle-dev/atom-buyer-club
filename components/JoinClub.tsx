...
export default function JoinClub() {
  ...
  return (
    <section style={{ padding: "160px 24px", background: "#1A1A1A", textAlign: "center", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "800px", height: "800px", background: "radial-gradient(circle, rgba(92,107,192,0.08) 0%, transparent 70%)", pointerEvents: "none" }}/>
      <div style={{ maxWidth: "720px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        >
          <span style={{ fontSize: "11px", letterSpacing: "0.15em", color: "#B8975A", fontFamily: "'DM Sans', sans-serif", display: "block", marginBottom: "24px" }}>{j.label}</span>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 300, color: "#F5F2ED", margin: "0 0 24px", letterSpacing: "-0.02em", lineHeight: 1.1 }}>
            {j.headline(MEMBER_COUNT)}
          </h2>
          <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "rgba(245,242,237,0.6)", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.7, margin: "0 0 48px", maxWidth: "480px", marginLeft: "auto", marginRight: "auto" }}>
            {j.subtitle}
          </p>
          <a
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: "10px", padding: "18px 40px", background: "#5C6BC0", color: "#FFFFFF", borderRadius: "2px", textDecoration: "none", fontSize: "15px", fontWeight: 500, letterSpacing: "0.04em", fontFamily: "'DM Sans', sans-serif", transition: "background 0.2s, transform 0.2s", marginBottom: "80px" }}
        ...
        >
          <div style={{ width: "48px", height: "1px", background: "rgba(245,242,237,0.15)", margin: "0 auto 40px" }}/>
          <p style={{ fontSize: "11px", letterSpacing: "0.12em", color: "rgba(245,242,237,0.3)", fontFamily: "'DM Sans', sans-serif", marginBottom: "24px" }}>
            {j.teamLabel}
          </p>
